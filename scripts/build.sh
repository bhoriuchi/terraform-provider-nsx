...
DEST_BIN="terraform-provider-$TF_PROVIDER_PKG"
...
echo ""
echo "Moving terraform-provider-${TF_PROVIDER_PKG}_${XC_OS}_${XC_ARCH} to $DEST_PATH/$DEST_BIN"
echo ""

mv terraform-provider-${TF_PROVIDER_PKG}_${XC_OS}_${XC_ARCH} $DEST_PATH/$DEST_BIN
